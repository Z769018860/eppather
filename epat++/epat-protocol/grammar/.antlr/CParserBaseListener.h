...
// Generated from d://Projects//epat++//epat-protocol//grammar//CParser.g4 by ANTLR 4.13.1
...
/**
 * This class provides an empty implementation of CParserListener,
 * which can be extended to create a listener which only needs to handle a subset
 * of the available methods.
 */
class  CParserBaseListener : public CParserListener {
public:
  ...
  virtual void enterSignStatement(CParser::SignStatementContext * /*ctx*/) override { }
  virtual void exitSignStatement(CParser::SignStatementContext * /*ctx*/) override { }
