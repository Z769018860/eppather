...
public:
  ...
  virtual std::any visitPrimary(CParser::PrimaryContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitConstant(CParser::ConstantContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitStringLiteral(CParser::StringLiteralContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitCommaExpression(CParser::CommaExpressionContext *ctx) override {
    return visitChildren(ctx);
  }
