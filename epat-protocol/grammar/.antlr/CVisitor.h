...
public:
   ...
   */
    ...
    virtual std::any visitPrimary(CParser::PrimaryContext *context) = 0;
    ...
    virtual std::any visitStringLiteral(CParser::StringLiteralContext *context) = 0;

    virtual std::any visitArgumentExpressionList(CParser::ArgumentExpressionListContext *context) = 0;

    virtual std::any visitCommaExpression(CParser::CommaExpressionContext *context) = 0;
