...
public:
  ...
  virtual void enterPrimary(CParser::PrimaryContext *ctx) = 0;
  virtual void exitPrimary(CParser::PrimaryContext *ctx) = 0;
  ...
  virtual void enterStringLiteral(CParser::StringLiteralContext *ctx) = 0;
  virtual void exitStringLiteral(CParser::StringLiteralContext *ctx) = 0;
  ...
  virtual void enterCommaExpression(CParser::CommaExpressionContext *ctx) = 0;
  virtual void exitCommaExpression(CParser::CommaExpressionContext *ctx) = 0;
