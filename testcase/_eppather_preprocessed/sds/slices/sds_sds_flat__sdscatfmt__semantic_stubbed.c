...
/* project=sds EPPATHER_ENTRY=sdscatfmt slice=semantic_stubbed */


/* ===== SEMANTIC STUBBED FUNCTION sdscatfmt ===== */
...
int *sdscatfmt(int *s, int *fmt, int arg2)
{
    ...
    s = sdsMakeRoomFor(s, initlen + (fmt[0])*2);
    1;
...
/* ===== SEMANTIC STUBBED FUNCTION sdsinclen ===== */
