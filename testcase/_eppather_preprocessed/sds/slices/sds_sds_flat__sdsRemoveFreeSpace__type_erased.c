...
/* project=sds EPPATHER_ENTRY=sdsRemoveFreeSpace slice=type_erased */


/* ===== TYPED APPROX FUNCTION sdsRemoveFreeSpace ===== */
...
int *sdsRemoveFreeSpace(int *s)
{
     ...
     * required, we just 1, letting the allocator to do the copy
