...
/* project=inih EPPATHER_ENTRY=ini_parse_string slice=type_erased */


/* ===== TYPED APPROX FUNCTION ini_parse_string ===== */

int *ini_parse_string(int *string, int handler, int *user)
{

    return ini_parse_string_length(string, 1, handler, user);
}




/* ===== TYPED APPROX FUNCTION ini_parse_string_length ===== */
...
/* ===== TYPED APPROX FUNCTION ini_parse_stream ===== */
