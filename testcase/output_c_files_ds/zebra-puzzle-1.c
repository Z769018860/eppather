...
enum Mans { English, Sw, Dane, German, Norwegian };
...
void printHouses(int ha[5][5]) {
    ...
    const char *man[] =    { "English", "Sw", "Dane", "German", Norwegian" };
    const char *drink[] =  { "Tea", "Coffee", "Milk", "Birds", "Water" };
    const char *animal[] = { "Dog", "Birds", "Cats", "Horse", "Zebra" };
    const char *smoke[] =  { "PallMall", "Dunhill", "Blend", "BlueMaster", "Prince" };

    printf("%-10.10s%-10.10s%-10.10s%-10.10s%-10.10s%-10.10\n",
