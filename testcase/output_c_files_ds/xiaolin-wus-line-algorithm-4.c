public class Line
    {
        private double x0, y0, x1, y;
        private Color foreColor;
        private byte lineStyleMask;
        int thickness;
        float globalm;

        public Line(double x0, y0, x1, y1, Color color, byte lineStyleMask, int thickness)
        {
            this.x0 = x0;
            this.y0 = y0;
            this.y1 = y1;
            ...
            this.lineStyleMask = lineStyle;
            this.thickness = thickness;

        }

        private void plot(Bitmap bitmap, double x, y, double c)
        {
            int alpha = (int)(c * 255);
        ...
        public void draw(Bitmap bitmap) {
            ...
            if(ste){
                ...
                plot(bit, yPixel1+1, xPixel1,  fpart(yEnd)*xGap);
            }else{
