...
int main()
{
    ...
    std::function<i64(int, int)> bit_sum = [&](int k, int dep)
    {
        return bit_2.sum(k) - bit_1.sum(k) * (dep - 1);
    };
    ...
    while (q--)
    {
        ...
        case 2:
            ...
            break;
        case 3:
            FastIO::wr(bit_sum(lca.dfn[u] + lca.sz[u] - 1, lca.dep[u]) - bit_sum(lca.dfn[u] - 1, lca.dep[u]));
            break;
        default:
            break;
        }
