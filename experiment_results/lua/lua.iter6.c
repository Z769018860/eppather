...
extern int fseeko (FILE *__stream, __off64_t __off, int __whence);
extern __off64_t ftello (FILE *__stream);
...
static void luaG_typeerror (lua_State *L, const TValue *o,
                                                const char *opname);
static void luaG_callerror (lua_State *L, const TValue *o);
static void luaG_forerror (lua_State *L, const TValue *o,
                                               const char *what);
static void luaG_concaterror (lua_State *L, const TValue *p1,
                                                  const TValue *p2);
static void luaG_opinterror (lua_State *L, const TValue *p1,
                                                 const TValue *p2,
                                                 const char *msg);
static void luaG_tointerror (lua_State *L, const TValue *p1,
                                                 const TValue *p2);
static void luaG_ordererror (lua_State *L, const TValue *p1,
                                                 const TValue *p2);
static void luaG_errnnil (lua_State *L, LClosure *cl, int k);
...
static void luaD_errerr (lua_State *L);
...
static void luaD_throw (lua_State *L, TStatus errcode);
static void luaD_throwbaselevel (lua_State *L, TStatus errcode);
...
static void numerror (LoadState *S, const char *what, const char *tname) {
